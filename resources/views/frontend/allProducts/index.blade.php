...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/custom-css/allProducts/index.css')}}">
...
<body>
    <header class="nav">
        ...
        <div class="navLink">
            <ul>
                ...
                <li><a href="{{url('oysterMushroom')}}">Oyster Mushroom</a></li>
                <li><a href="{{url('buttonMushroom')}}">Button Mushroom</a></li>
    ...
    <div class="spacing">
        <div>
            <h1 class="container-fluid header1">Mushroom Products</h1>
        </div>
        <div class="boxsize">
