...
@section('title', 'A.K.R|Register - Page')
        ...
        <div class="card-body">
          ...
          <div class="app-brand justify-content-center mb-4">
            <a href="{{url('/')}}" class="app-brand-link gap-2">
              ...
              <span class="app-brand-logo demo"><img src="{{asset('assets/img/dashboard/akr_logo_transparent.png')}}" alt="A.K.R" srcset="" width="300"></span>
